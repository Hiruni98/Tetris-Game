...
/*
*	clicked() signal is from the Start and Pause/play buttons to the board, and from the
*	Quit button to the application's QApplication::quit() slot
*/
    connect(startButton, &QPushButton::clicked, board, &TetrixBoard::start);
    connect(quitButton , &QPushButton::clicked, qApp, &QApplication::quit);
    connect(pauseButton, &QPushButton::clicked, board, &TetrixBoard::pause);
    connect(volumeDial, SIGNAL(valueChanged(int)),board, SLOT(setVolume(int)));
